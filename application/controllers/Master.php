...
class Master extends CI_Controller
{
  ...
  private function _addDept()
  {
    ...
    if ($checkId > 0)
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to add, Department id is used!</div>');
    }
    else
    {
      $this->db->insert('department', $data);
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully added a new department!</div>');
    }
  ...
  private function _editDept($d_id, $name)
  {
    ...
    $this->session->set_flashdata
      ('message', '<div class = "alert alert-success" role = "alert">Successfully edited a department!</div>');
  ...
  public function d_dept($d_id)
  {
    ...
    $this->session->set_flashdata
      ('message', '<div class = "alert alert-success" role ="alert">Successfully deleted a department!</div>');
  ...
  public function shift()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/shift/index', $d); // Attendance Time Page
    $this->load->view('templates/table_footer');
  }
  ...
  public function a_shift()
  {
    ...
    if ($this->form_validation->run() == false)
    {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('master/shift/a_shift', $d); // Add Attendance Time Page
      $this->load->view('templates/footer');
    } 
    else
    {
  ...
  private function _addShift()
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully added a new shift!</div>');
    }
    else
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to add new shift!</div>');
    }
  ...
  private function _editShift($s_id, $set)
  {
    ...
    $this->session->set_flashdata
      ('message', '<div class = "alert alert-success" role = "alert">Successfully edited a shift!</div>');
  ...
  public function d_shift($s_id)
  {
    ...
    $this->db->query($query);
    $this->session->set_flashdata
      ('message', '<div class = "alert alert-success" role = "alert">Successfully deleted a shift!</div>');
    redirect('master/shift');
  }
  ...
  private function _addEmployee()
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Email already used!</div>');
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully added a new employee!</div>');
    }
    else
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to add data!</div>');
    }
  ...
  private function _editEmployee($e_id, $data, $department)
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully updated an employee!</div>');
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to update employee\'s data!</div>');
      redirect('master/employee');
    }
  }
  ...
  public function d_employee($e_id)
  {
    ...
    $this->session->set_flashdata
      ('message', '<div class = "alert alert-success" role = "alert">Successfully deleted an employee!</div>');
  ...
  private function _addLocation($data)
  {
    ...
    $checkName = $this->db->get_where('location', [ 'name' => $data['name'] ] )->num_rows();

    if ($checkName > 0)
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to add, Position name is used!</div>');
    }
    else
    {
  ...
  public function e_location($l_id)
  {
    ...
    if ($this->form_validation->run() == false)
    {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('master/Location/e_location', $d); // Edit Position Page
      $this->load->view('templates/footer');
    } 
    else
    {
  ...
  private function _editLocation($l_id, $name)
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully edited a location!</div>');
    }
    else
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to edit data!</div>');
    }
  ...
  public function d_location($l_id)
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class ="alert alert-success" role = "alert">Successfully deleted a location!</div>');
    } 
    else
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to delete a data!</div>');
    }
  ...
  private function _addUsers($data)
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully created an account!</div>');
    }
    else
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to create account!</div>');
    }
  ...
  private function _editUsers($data, $username)
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully edited an account!</div>');
    }
    else
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to edit account!</div>');
    }
  ...
  public function d_users($username)
  {
    ...
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-success" role = "alert">Successfully deleted an account!</div>');
    } 
    else 
    {
      $this->session->set_flashdata
        ('message', '<div class = "alert alert-danger" role = "alert">Failed to delete account!</div>');
    }
  ...
  public function salary()
  {
    ...
    $d['attendance'] = $this->_salaryDetails( $d['start'], $d['end'], $d['dept_code'] );

    $this->load->view('templates/table_header', $d);
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('master/salary/index', $d);
    $this->load->view('templates/table_footer');
  }

  private function _salaryDetails($start, $end, $dept)
  {
    if ($start == '' || $end == '')
    {
      return false;
